...
export default function PromptsGrid() {
  ...
  // Calcular subcategorías disponibles dinámicamente
  ...
  return (
    <div className="w-full animate-in fade-in duration-500">
      ...
      <div className="flex flex-wrap gap-3 mb-8 justify-center">
        ...
        {/* Generamos los botones dinámicamente según las claves de MAIN_LABELS */}
      ...
      {/* SUBMENÚ (Aparece al seleccionar categoría) */}
