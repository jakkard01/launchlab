    ...
    >
      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-[rgba(7,17,26,0.82)] backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
          <a
            href="#inicio"
            className="text-sm font-semibold tracking-[0.18em] text-white/88"
          >
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-16 px-4 pb-16 pt-8 sm:px-6 sm:pb-24 sm:pt-12">
        ...
        >
          <div>
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-white/72 sm:text-lg">
              PBIA construye una base comercial más clara, más rápida y mejor
              conectada. Después suma bots, automatizaciones y demos solo cuando
              ayudan a vender mejor.
            </p>
              ...
              <div className="mt-5 grid gap-3">
                <div className="rounded-2xl border border-white/8 bg-white/[0.03] p-4">
                  ...
                  <p className="mt-1 text-sm leading-6 text-white/68">
                    Qué haces, qué problema resuelves y cuál es la siguiente
                    acción.
                  </p>
                </div>
                <div className="rounded-2xl border border-white/8 bg-white/[0.03] p-4">
                  <p className="text-sm font-semibold text-white">
                    Capacidades secundarias con criterio
                  </p>
                  <p className="mt-1 text-sm leading-6 text-white/68">
                    Bots, automatizaciones y demos entran cuando refuerzan la
                    conversión, no para crear bazar.
                  </p>
                </div>
                <div className="rounded-2xl border border-white/8 bg-white/[0.03] p-4">
                  <p className="text-sm font-semibold text-white">
                    Cierre con acción real
                  </p>
                  <p className="mt-1 text-sm leading-6 text-white/68">
        ...
        <section id="que-hacemos" className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-[1.6rem] border border-white/10 bg-white/[0.03] p-5 backdrop-blur-[4px]">
            <p className="text-base leading-7 text-white/74">
              La idea es simple: explicar mejor lo que vendes, responder más
              rápido y facilitar que una visita se convierta en conversación o
              venta.
            </p>
          </div>
        </section>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-white/66 sm:text-base">
                Aquí no enseñamos juguetes. Mostramos un caso real y dejamos
                visibles las capacidades secundarias para validar mensaje,
                respuesta o automatización cuando hace falta.
              </p>
            </div>
            <a
              href={WHATSAPP_LINK}
        ...
        <section className="grid gap-5 rounded-[1.8rem] border border-white/10 bg-white/[0.03] p-5 backdrop-blur-[4px] sm:p-7 lg:grid-cols-[0.85fr_1.15fr]">
          <div>
            <p className="text-xs uppercase tracking-[0.24em] text-cyan-200">
              Quién está detrás
            </p>
          ...
          <div className="space-y-4 text-sm leading-7 text-white/72 sm:text-base">
            <p>
              Powered by IA busca construir activos digitales que se entiendan
              rápido, transmitan autoridad y empujen a una acción concreta. La
              prioridad no es acumular servicios, sino ordenar sistemas
              comerciales que funcionen de verdad.
            </p>
            <p>
              El trabajo mezcla mensaje, lógica comercial y ejecución técnica en
              el mismo flujo. Menos bazar digital y más estructura útil para
              captar, responder y convertir mejor.
            </p>
          </div>
        </section>
        ...
        >
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-base leading-7 text-white/74">
              Escríbeme por WhatsApp, cuéntame qué estás vendiendo y te respondo
              con la ruta más razonable para captar mejor, responder con más
              orden o mejorar conversión sin llenar tu negocio de más ruido.
            </p>
            <p className="mt-3 text-sm leading-6 text-white/60">
              El botón abre WhatsApp con un mensaje base listo para que el
              primer contacto sea rápido y directo.
            </p>
            <p className="mt-3 text-sm leading-6 text-white/68">
