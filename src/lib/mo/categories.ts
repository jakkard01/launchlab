export const MO_CATEGORY_DEFINITIONS = [
  {
    ...
    label: "Bebidas",
    shortLabel: "Bebidas",
    image: "/RYSminisuper/icons/pasillos/bebidas.webp",
    fallbackImage: "/mo/categories/bebida.svg",
  ...
  },
  {
    ...
    shortLabel: "Snacks",
    image: "/RYSminisuper/icons/pasillos/snacks.webp",
    fallbackImage: "/mo/categories/snacks.svg",
  ...
  },
  {
    ...
    image: "/mo/categories/pan.svg",
    fallbackImage: "/mo/categories/pan.svg",
  ...
  },
  {
    ...
    shortLabel: "Café",
    image: "/mo/categories/cafe.svg",
    fallbackImage: "/mo/categories/cafe.svg",
  ...
  },
  {
    ...
    shortLabel: "Lácteos",
    image: "/RYSminisuper/icons/pasillos/lacteos.webp",
    fallbackImage: "/mo/categories/lacteos.svg",
  ...
  },
  {
    ...
    image: "/RYSminisuper/icons/pasillos/abarrotes.webp",
    fallbackImage: "/mo/categories/abarrotes.svg",
  ...
  },
  {
    ...
    shortLabel: "Higiene",
    image: "/mo/categories/abarrotes.svg",
    fallbackImage: "/mo/categories/abarrotes.svg",
  ...
  },
  {
    ...
    shortLabel: "Frutas",
    image: "/mo/categories/snacks.svg",
    fallbackImage: "/mo/categories/snacks.svg",
  ...
  },
  {
    ...
    image: "/RYSminisuper/icons/pasillos/comida_caliente.webp",
    fallbackImage: "/mo/categories/antojitos.svg",
  ...
  },
  {
    ...
    label: "Econocombos",
    shortLabel: "Combos",
    image: "/RYSminisuper/icons/pasillos/combos.webp",
    fallbackImage: "/RYSminisuper/icons/pasillos/combos.webp",
...
export const getMoCategoryImage = (value: string) => {
  ...
  return category?.image ?? category?.fallbackImage ?? "/mo/categories/abarrotes.svg";
};

export const getMoCategoryFallbackImage = (value: string) =>
  getMoCategoryById(value)?.fallbackImage ?? "/mo/categories/abarrotes.svg";
